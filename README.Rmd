...
[![drat status](https://img.shields.io/badge/drat-0.1.6-red.svg)](https://github.com/schochastics/drat)
[![drat status](https://img.shields.io/badge/networks-2142-green.svg)](https://github.com/schochastics/networkdata)
<!-- badges: end -->
...
The package includes `r length(list.files("data"))` datasets containing 2142 networks. 
