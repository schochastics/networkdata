...
[![drat status](https://img.shields.io/badge/networks-2145-green.svg)](https://github.com/schochastics/networkdata)
<!-- badges: end -->
...
The package includes `r length(list.files("data"))` datasets containing 2145 networks. 
