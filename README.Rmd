...
[![drat status](https://img.shields.io/badge/networks-2257-green.svg)](https://github.com/schochastics/networkdata)
<!-- badges: end -->
...
The package includes `r length(list.files("data"))` datasets containing 2257 networks. 
